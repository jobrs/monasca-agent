...
class HAProxy(monasca_setup.detection.Plugin):
    ...
    def build_config(self):
        ...
        config.merge(monasca_setup.detection.watch_process(['haproxy'], component='haproxy', exact_match=False))
        if monasca_setup.detection.find_process_cmdline('keepalived') is not None:
            config.merge(monasca_setup.detection.watch_process(['keepalived'], component='haproxy', exact_match=False))
